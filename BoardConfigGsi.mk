...
BOARD_AVB_SYSTEM_KEY_PATH := device/oneplus/oneplus6/verifiedboot.key
BOARD_AVB_SYSTEM_ALGORITHM := SHA256_RSA4096
BOARD_AVB_SYSTEM_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_SYSTEM_ROLLBACK_INDEX_LOCATION := 2
BOARD_AVB_BOOT_KEY_PATH := device/oneplus/oneplus6/verifiedboot.key
BOARD_AVB_BOOT_ALGORITHM := SHA256_RSA4096
BOARD_AVB_BOOT_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_BOOT_ROLLBACK_INDEX_LOCATION := 1
BOARD_AVB_DTBO_KEY_PATH := device/oneplus/oneplus6/verifiedboot.key
BOARD_AVB_DTBO_ALGORITHM := SHA256_RSA4096
BOARD_AVB_DTBO_ROLLBACK_INDEX := $(PLATFORM_SECURITY_PATCH_TIMESTAMP)
BOARD_AVB_DTBO_ROLLBACK_INDEX_LOCATION := 3
#BOARD_AVB_VENDOR_KEY_PATH := device/oneplus/oneplus6/verifiedboot.key
